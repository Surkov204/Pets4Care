                        ...
                        <table class="salary-table">
                            ...
                            <tbody>
                                <c:if test="${not empty sessionScope.latestPayroll}">
                                    <tr>
                                        <td>
                                            <fmt:formatDate value="${sessionScope.latestPayroll.periodStart}" pattern="MM/yyyy" />
                                        </td>

                                        <td>${sessionScope.latestPayroll.daysWorked}</td>

                                        <td>${sessionScope.latestPayroll.standardWorkingDays}</td>

                                        <td>
                                            <fmt:formatNumber value="${sessionScope.latestPayroll.monthlyBaseSalary}"
                                                              type="number" groupingUsed="true"/> ₫
                                        </td>

                                        <td>
                                            <b><fmt:formatNumber value="${sessionScope.latestPayroll.totalSalary}"
                                                              type="number" groupingUsed="true"/> ₫</b>
                                        </td>

                                        <td>
                                            <fmt:formatDate value="${sessionScope.latestPayroll.createdAt}" pattern="dd/MM/yyyy HH:mm" />
                                        </td>
                                    </tr>
                                </c:if>

                                <c:if test="${empty sessionScope.latestPayroll}">
                                    <tr><td colspan="6" class="empty-msg">Chưa có dữ liệu lương.</td></tr>
                                </c:if>
                            </tbody>
                        </table>
                    </div>
