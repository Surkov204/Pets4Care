...
<%
    // Xử lý cookies để tự động điền form
    ...
    // Đặt các giá trị vào request để JSP có thể sử dụng
    ...
    <head>
        ...
        <style>
            :root {
                ...
                --shadow-hover: 0 4px 28px 0 rgba(140, 170, 205, 0.18);
            ...
            * {
            ...
            body {
                ...
                background: linear-gradient(135deg, var(--main-bg), var(--card-bg-alt));
                min-height: 100vh;
                display: flex;
            ...
            .login-container {
                ...
                margin: 2rem 0; /* Thêm margin để không bị dính sát mép */
            }

            .login-container:hover {
                transform: translateY(-5px);
                box-shadow: 0 8px 32px 0 rgba(140, 170, 205, 0.25);
            }
            ...
            .divider::after {
                content: "";
                flex: 1;
                border-bottom: 1px solid rgba(111, 213, 221, 0.3);
                margin: 0 0.8rem;
            }
    ...
    <body>
        ...
        <div class="login-container">
            ...
            <div class="tab-container">
                ...
                <button id="tab-staff" class="tab-button" onclick="showTab('staff')">
            ...
            <div id="customer-form" class="form-container active">
                <form action="login" method="post">
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" class="form-input" 
                               value="${rememberedEmail}" required placeholder="Nhập địa chỉ email của bạn">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" id="password" class="form-input" 
                               value="${rememberedPassword}" required placeholder="Nhập mật khẩu">
                    </div>

                    <div class="password-actions">
                        <div class="checkbox-container">
                            <input type="checkbox" name="rememberMe" id="rememberMe" class="checkbox-input"
                                   <c:if test="${not empty rememberedPassword}">checked</c:if>>
                ...
                <!-- Staff Login Form -->
                <div id="staff-form" class="form-container">
                    <form action="staff-login" method="post">
                        <div class="form-group">
                            <label for="staff-email" class="form-label">
                                <i class="fas fa-envelope"></i> Email nhân viên
                            </label>
                            <input type="email" name="email" id="staff-email" class="form-input"
                                   required placeholder="Nhập email nhân viên">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password" id="staff-password" class="form-input"
                ...
                <a href="logingoogle" class="block">
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                // Create additional floating pets
                for (let i = 7; i <= 12; i++) {
                    ...
                    const pos = positions[(i - 7) % positions.length];
                    Object.assign(pet.style, pos);

                    // Random animation
                    const duration = 6 + Math.random() * 8;
                    const delay = Math.random() * 5;

                    pet.style.animation = `float${(i % 6) + 1} ${duration}s infinite`;
                    pet.style.animationDelay = `${delay}s`;
                    pet.style.fontSize = `${1.2 + Math.random() * 0.8}rem`;
                    pet.style.opacity = `${0.3 + Math.random() * 0.3}`;

                    container.appendChild(pet);
                }

                // Add cute hover effects to form inputs
