...
<html lang="vi">
    <head>
        ...
        <title>Chỉnh sửa danh mục - PET TOY SHOP</title>
    ...
    <body>
        ...
        <div class="admin-content">
            ...
            <c:if test="${empty category}">
                <div class="alert alert-error">Không tìm thấy danh mục để chỉnh sửa.</div>
                <a href="categories?action=list" class="btn">← Quay lại danh sách</a>
            </c:if>
        </div>
